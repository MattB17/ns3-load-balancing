...
Ipv4LetFlowRouting::Ipv4LetFlowRouting():
    m_flowletTimeout(MicroSeconds(50)), m_ipv4(0) {
...
// Get all the flowlet entries heading to dest.
...
bool Ipv4LetFlowRouting::RouteInput(
	...
	// If there are no routing entries to the destination.
...
void Ipv4LetFlowRouting::NotifyRemoveAddress(uint32_t interface, Ipv4InterfaceAddress address) {
}
